    ...
    if (isset($_POST['register'])) { 
            ...
            if($pwd == $pwdConfirm){
                ...
                if($detectUser == false){
                    ...
                    $id_gen = rand(1, 10000);
                    $sql = "INSERT INTO Buyer (buyer_id, username, password, first_name, last_name, email)
                    VALUES($id_gen,'$username', '$pwdHash', '$first_name', '$last_name', '$email')";
                    if ($conn->query($sql) === TRUE) {
                        echo "Data is inserted in Buyer Database <br>";
                         //after registration, redirect to card-info.php
                         $_SESSION['buyer-register'] = 1;
...
<head>
    ...
    <title>Register Buyer Page</title>
...
<body>
    <br><br><br>
    <div class="wrap">
        <form class="form-page" action="buyer-register.php" method="post" name="Register_Form">
            <h2 style="text-align:center; padding-bottom: 15px">Register Buyer</h2>
            ...
            <div class="login-or-register">
                <p>Already have an account? <a href="buyer-login.php">Sign in</a>.</p>
            </div>
        </form>
    </div>
